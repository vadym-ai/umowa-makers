 ...
 *
 * IMPORTANT: this logic is duplicated in
 * supabase/functions/generate-contract-pdf/rachunekCalc.ts
 * because edge functions cannot import from src/. Keep both files identical.
 */
